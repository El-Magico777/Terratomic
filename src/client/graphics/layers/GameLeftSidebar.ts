...
export class GameLeftSidebar extends LitElement implements Layer {
  ...
  render() {
    return html`
      <aside
        class=${`fixed bottom-4 right-4 z-[1000] flex flex-col max-h-[calc(100vh-80px)] overflow-y-auto p-2 bg-slate-800/40 backdrop-blur-sm shadow-xs rounded-tl-lg rounded-bl-lg transition-transform duration-300 ease-out transform ${

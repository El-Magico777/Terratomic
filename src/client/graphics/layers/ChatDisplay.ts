    ...
    return html`
      <div
        class="${this._hidden
          ...
          : ""} rounded-md bg-black bg-opacity-60 relative max-h-[30vh] flex flex-col-reverse overflow-y-auto w-full lg:top-0 lg:left-0 z-50 lg:max-w-[30vw] lg:w-full lg:w-auto"

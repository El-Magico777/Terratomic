    ...
    return html`
      <div
        class="${this._hidden
          ...
          : ""} rounded-md bg-dark-gray border border-steel shadow-glow-green relative flex flex-col-reverse overflow-y-auto w-full h-full"
        style="pointer-events: auto"
      >
        <div>
          <div class="w-full bg-dark-gray sticky top-0 px-[10px]">
            <button

    ...
    return html`
      <div
        class="${this._hidden
          ...
          : ""} rounded-md bg-black bg-opacity-60 relative max-h-[30vh] flex flex-col-reverse overflow-y-auto w-full z-50 lg:max-w-[30vw] lg:w-full lg:w-auto"
        style="pointer-events: auto; top: 2.5rem; left: 2.5rem;"
      >
        <div>
